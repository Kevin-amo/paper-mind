...
public class EmbeddingServiceImpl implements EmbeddingService {
    ...
    public List<EmbeddingVector> embed(List<DocumentChunk> chunks) {
        if (chunks == null || chunks.isEmpty()) {
            log.info("嵌入开始 chunkCount={} sourceIdDistribution={} totalChars={}", 0, Map.of(), 0);
            log.info("嵌入完成 chunkCount={} vectorCount={} sourceIdDistribution={} totalChars={} costMs={}", 0, 0, Map.of(), 0, 0);
            return List.of();
        }
        ...
        log.info("嵌入开始 chunkCount={} sourceIdDistribution={} totalChars={}", chunks.size(), sourceDistribution, totalChars);
        try {
            ...
            log.info("嵌入完成 chunkCount={} vectorCount={} sourceIdDistribution={} totalChars={} costMs={}",
                    chunks.size(), vectors.size(), sourceDistribution, totalChars, elapsedMs(startNanos));
            return vectors;
        } catch (RuntimeException ex) {
            log.error("嵌入失败 chunkCount={} sourceIdDistribution={} totalChars={} costMs={}",
